 ...
 */
async function getCroppedImg(imageSrc, pixelCrop, fileName = "image.jpg") {
 ...
 *  - onCancel: () => void
 *  - aspect: number (e.g. 1 for square, 16/9 for wide)
 *  - cropShape: 'rect' | 'round'
 *  - title: string
 *  - subtitle: string
 */
const UniversalImageCropper = ({ 
  imageSrc, 
  onCropDone, 
  onCancel, 
  aspect = 1, 
  cropShape = "rect",
  title = "Crop Image",
  subtitle = "Drag to reposition · Pinch or slide to zoom"
}) => {
  React.useEffect(() => {
